# Migración QCUT a nuevo Firebase y nueva cuenta de Apps Script

## Estado actual en código

- Firebase web config ya migrado al proyecto `qcut-332fd`.
...
3. Crear usuarios administradores (barberos) en Firebase Auth.
...
3. Confirmar que copiaste el script correcto de QCUT:
...
VITE_FIREBASE_AUTH_DOMAIN=qcut-332fd.firebaseapp.com
VITE_FIREBASE_PROJECT_ID=qcut-332fd
VITE_FIREBASE_STORAGE_BUCKET=qcut-332fd.firebasestorage.app
