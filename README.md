# Qita - Sistema de Gestión de Citas para Negocios

Sistema SaaS moderno para gestionar citas de negocios y profesionales, con diseño elegante inspirado en Apple/iOS y funcionalidades en tiempo real usando Firebase.
...
- ✅ **Perfil del negocio**: Nombre, teléfono, dirección
...
- ✅ **Notificaciones automáticas** al profesional (email)
...
Estructura estándar de Firestore para cada negocio (la colección `barbers` se mantiene para compatibilidad):
...
- Crear documento en `barbers/{uid}/config/barberdata` con los datos del negocio
...
**Qita** - Sistema profesional de gestión de citas para barberías 💈
