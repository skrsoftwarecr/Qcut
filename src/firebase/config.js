...
const firebaseConfig = {
  ...
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || 'qita-332fd.firebaseapp.com',
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || 'qita-332fd',
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || 'qita-332fd.firebasestorage.app',
