    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="relative">
              <img src="/logo-qita.svg" alt="Qita" className="w-14 h-14 object-cover rounded-lg shadow-sm" />
            </div>
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-1">Qita</h1>
          <p className="text-gray-500 text-sm">Gestión de citas para negocios</p>
        </div>
        ...
        <p className="text-center text-gray-500 text-xs mt-6">
          Gestión profesional de citas para negocios
        </p>
      </div>
    </div>
  );
